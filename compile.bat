...
"Compiler/bin/lcc" -Wa-l -Wl-m -Wl-j -DUSE_SFR_FOR_REG -Wl-yt2 -Wl-yo8 -Wl-ya1 -o "SkazkaV2/SkazkaV2.gb" "SkazkaV2/SkazkaV2.o" "SkazkaV2/music.o" "SkazkaV2/bk1-bkg.o" "SkazkaV2/bk2-bkg.o" "SkazkaV2/bk3-bkg.o" "SkazkaV2/bk4-story.o"
